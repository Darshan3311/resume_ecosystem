...
public class ResumeController {
    ...
    public ResponseEntity<ApiResponse<User>> getResume(
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Resume retrieved successfully", user)
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> addWorkExperience(
            @PathVariable String userId,
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Work experience added successfully", user)
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> updateWorkExperience(
            @PathVariable String userId,
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Work experience updated successfully", user)
        );
    }

    @DeleteMapping("/{userId}/experience/{expId}")
    @Operation(summary = "Delete work experience", description = "Delete work experience entry")
    public ResponseEntity<ApiResponse<User>> deleteWorkExperience(
            @PathVariable String userId,
            @PathVariable String expId,
            Authentication authentication) {
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Work experience deleted successfully", user)
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> addProject(
            @PathVariable String userId,
    ...
    public ResponseEntity<ApiResponse<User>> updateProject(
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Project updated successfully", user)
        );
    }

    @DeleteMapping("/{userId}/projects/{projectId}")
    @Operation(summary = "Delete project", description = "Delete project entry")
    public ResponseEntity<ApiResponse<User>> deleteProject(
            @PathVariable String userId,
            @PathVariable String projectId,
            Authentication authentication) {
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Project deleted successfully", user)
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> addEducation(
            @PathVariable String userId,
    ...
    public ResponseEntity<ApiResponse<User>> updateEducation(
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Education updated successfully", user)
        );
    }

    @DeleteMapping("/{userId}/education/{eduId}")
    @Operation(summary = "Delete education", description = "Delete education entry")
    public ResponseEntity<ApiResponse<User>> deleteEducation(
            @PathVariable String userId,
            @PathVariable String eduId,
            Authentication authentication) {
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Education deleted successfully", user)
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> addCertification(
            @PathVariable String userId,
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Certification added successfully", user)
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> updateCertification(
            @PathVariable String userId,
    ...
    public ResponseEntity<ApiResponse<User>> deleteCertification(
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Certification deleted successfully", user)
        );
    }
    ...
    public ResponseEntity<ApiResponse<User>> updateSkills(
            @PathVariable String userId,
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Skills updated successfully", user)
        );
    }

    @PostMapping("/{userId}/skills")
    @Operation(summary = "Add skill", description = "Add a single skill")
    public ResponseEntity<ApiResponse<User>> addSkill(
            @PathVariable String userId,
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Skill added successfully", user)
        );
    }

    @DeleteMapping("/{userId}/skills/{skill}")
    @Operation(summary = "Delete skill", description = "Remove a single skill")
    public ResponseEntity<ApiResponse<User>> deleteSkill(
            @PathVariable String userId,
        ...
        return ResponseEntity.ok(
                new ApiResponse<>(true, "Skill deleted successfully", user)
        );
    }
}
